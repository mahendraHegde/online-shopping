<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LogisticLogReg.aspx.cs" Inherits="SellerLogReg" %>
...
<script type="text/javascript" src="js/jquery.js"></script>
    <title>Logistic Register/Login</title>
...
<body style="font-size: 12pt" bgcolor="gainsboro" onload="msgbox()">
    ...
    <div class="login1" id="login1">
       ...
       <h1> Logistic Login </h1>
       </div>
       
       <div class="panel1">
                <label>Email ID:</label>
                <asp:TextBox CssClass="largetxt2" ID="txtlogisticid" runat="server"></asp:TextBox> 
                <div class="user-icon1"></div>
                <label>Password:</label>
                <asp:TextBox CssClass="largetxt3" ID="txtlogisticpswd" runat="server" TextMode="Password"></asp:TextBox>
